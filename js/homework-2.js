...
const DIVISIBLE = parseInt(prompt('Ingrese un número del 0 a 100 para ver si es divisible entre 2 y 11.'))
...
const EVEN = parseInt(prompt('Ingrese un número del 0 a 100 para ver si es par.'))
if (EVEN % 2 === 0){
...
const DAYWEEK = parseInt(prompt('Ingrese un número del 1 al 7'))
switch (DAYWEEK) {
    case '1':
    ...
    case '7':
        ...
        break;
    default:
        const DAYWEEKTWO = parseInt(prompt('Ingrese un número del 1 al 7'))
}
